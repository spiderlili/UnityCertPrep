...
{
    private string assetBundleUrl = "https://github.com/spiderlili/UnityCertPrep/blob/master/Assets/BundledAssets/onlineBundle/playerbrutius";
    private string prefabName = "Brutius.prefab";
    //fallback url: http://files.holistic3d.com/Bundles/brutius

    // it must wait for the web call to occur
    IEnumerator Start()
    {
        var unityWebRequestAB = UnityWebRequestAssetBundle.GetAssetBundle(assetBundleUrl);
